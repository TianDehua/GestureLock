            ...
            switch (event.getActionMasked()) {
                    ...
                    if (child != null && child instanceof GestureLockView && checkChildInCoords(lastX, lastY, child)) {
                        ...
                        if (!checked) {
                            ...
                            if (gesturePath == null) {
                                ...
                                /*-----------------------add arrow draw, when LOCKER_STATE_SELECTED--------------------------------------------*/
                                View preView = findViewById(gesturesContainer[gestureCursor - 1] + 1);
                                int dx = child.getLeft() - preView.getLeft();
                                int dy = child.getTop() - preView.getTop();
                                int angle = (int) Math.toDegrees(Math.atan2(dy, dx)) + 90;
                                ((GestureLockView) preView).setArrow(angle);
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (gesturesContainer[0] != -1) {
                        ...
                        /*--------check length is equal, if true, then check value------------------*/
                        int containerLen = 0;
                        ...
                        if(containerLen == defaultGestures.length)
